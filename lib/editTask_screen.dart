...
class _EditTaskScreenState extends State<EditTaskScreen> {
  ...
  void _addTask() {
    widget.mainTasksTitlesList.removeAt(widget.index);
    widget.mainTasksDetailsList.removeAt(widget.index);
    widget.mainTasksTitlesList.insert(widget.index, _taskTitle.text);
    widget.mainTasksDetailsList.insert(widget.index, _taskDescription.text);
    _saveData();
